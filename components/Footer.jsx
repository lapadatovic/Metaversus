    ...
    >
       <div 
        className="flex items-center justify-between flex-wrap gap-5">
          <h4 className="font-bold md:font-[64px] text-[44px] text-white"> 
            Enter the Metaverse 
          </h4>
          <button 
            type="button"
            className="flex items-center py-4 px-6 bg-[#2561ab] h-fit rounded-[32px] gap-[12px]"
          >
            <img src="/headset.svg" alt="headeset_img" 
